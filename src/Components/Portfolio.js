...
import { Mail, Linkedin, ExternalLink, Code, Database, Server, GraduationCap, Award, ChevronDown, Calendar, MapPin, ArrowRight } from 'lucide-react';
    ...
    <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white min-h-screen relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <a
              ...
              className="px-6 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105"
            >
              Get in Touch
            </a>
          </div>
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-12">
            <a
              href="mailto:viji592001@gmail.com"
              className="group px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full font-semibold flex items-center gap-2 hover:shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300 hover:scale-105"
            >
              <Mail size={20} />
              Email Me
            ...
            <a
              ...
              className="px-8 py-4 border-2 border-gray-700 rounded-full font-semibold flex items-center gap-2 hover:border-cyan-500 hover:bg-cyan-500/10 transition-all duration-300"
            >
              <Linkedin size={20} />
              LinkedIn
            </a>
          ...
          <button
            ...
            className="animate-bounce mt-12 text-gray-400 hover:text-cyan-400 transition-colors"
          >
            <ChevronDown size={32} />
          </button>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">Coimbatore, India</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-400 rounded-full mt-2" />
                  <div>
                    <div className="font-semibold text-white">Current Role</div>
                    <div className="text-gray-400">Associate Software Engineer at BAPS</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">MCA from Alagappa University</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project) => (
              <div
                key={project.id}
                className="group relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 hover:border-cyan-500/50 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-6 p-4 bg-slate-900/50 rounded-lg border-l-4 border-cyan-500">
                    <div className="text-sm font-semibold text-cyan-400 mb-1">Impact</div>
                    <div className="text-gray-300">{project.impact}</div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((tech, idx) => (
                      <span
                        key={idx}
                        className="px-3 py-1 bg-slate-900/50 border border-slate-700 rounded-full text-xs text-gray-300"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {Object.entries(skills).map(([category, items], idx) => {
              ...
              return (
                <div
                  key={category}
                  className="group bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 hover:border-cyan-500/50 transition-all duration-300"
                >
                  <div className="flex items-center gap-3 mb-6">
                    <div className={`p-3 bg-gradient-to-br ${colors[idx]} rounded-lg`}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {items.map((skill, i) => (
                      <span
                        key={i}
                        className="px-3 py-1.5 bg-slate-900/50 border border-slate-700 rounded-lg text-sm text-gray-300 hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300 cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              <div className="relative pl-20">
                {/* Timeline dot */}
                <div className="absolute left-6 top-2 w-5 h-5 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full border-4 border-slate-900" />
                
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 hover:border-cyan-500/50 transition-all duration-300">
                  <div className="flex flex-wrap justify-between items-start gap-4 mb-4">
                    <div>
                      <h3 className="text-2xl font-bold text-white mb-2">Associate Software Engineer</h3>
                      <div className="text-cyan-400 font-semibold">BAPS</div>
                    </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={idx}
                className={`bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border rounded-2xl p-6 ${
                  edu.highlight 
                    ? 'border-cyan-500/50 md:col-span-2' 
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-cyan-400 mb-1">{edu.institution}</p>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-cyan-400 font-semibold mb-1">{cert.org}</p>
      ...
      <footer className="py-12 px-6 border-t border-slate-800">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-2">Designed & Developed by Vijayalakshmi S</p>
